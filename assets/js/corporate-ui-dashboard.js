...
// Mostrar el spinner cuando se carga el video
videoPlayer.addEventListener("loadstart", () => {
  spinner.style.display = "block";
});

// Ocultar el spinner cuando el video está listo para reproducirse
videoPlayer.addEventListener("canplay", () => {
  spinner.style.display = "none";
});

// Ocultar el spinner cuando ocurra un error
videoPlayer.addEventListener("error", () => {
  spinner.style.display = "none";
});

// Opcional: Mostrar el spinner cuando se cargue una URL externa
document.getElementById("loadUrl").addEventListener("click", () => {
  const urlInput = document.getElementById("urlInput").value;
  if (urlInput) {
    spinner.style.display = "block";
    videoPlayer.src = urlInput;
  }
});
